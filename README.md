...
- 🚀 **随 Antigravity 启动自动运行**：
  - 汉化补丁自动在 Electron 主进程注入安全守护逻辑，随主程序启动无感拉起桌宠；
  - 右上角设置面板（齿轮按钮）与系统托盘菜单提供双向一键开关，支持随时开启或关闭自启。
...
### 🚀 启动与使用
- **随 Antigravity 自启**：默认开启，打好汉化补丁后打开 Antigravity 即可自动拉起；
